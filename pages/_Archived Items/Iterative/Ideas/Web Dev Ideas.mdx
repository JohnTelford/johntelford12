...
[Iterative and incremental development](https://en.wikipedia.org/w/index.php?title=Iterative_and_incremental_development) Good read. Compares Iterative with Waterfall
